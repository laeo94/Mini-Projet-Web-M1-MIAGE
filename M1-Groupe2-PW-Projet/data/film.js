var filmData = [{
    ...
    {
        genre: ["anime", "drame", "romance"],
        title: "Souvenirs de Marnie",
        image: "images/souvenirs_de_marnie.jpg",
        text: `Anna, jeune fille solitaire, vit en ville avec ses parents adoptifs. Un été, elle est envoyée dans un petit village au nord d'Hokkaïdo. Dans une vieille demeure inhabitée, au coeur des marais, elle va se lier d'amitié avec l'étrange Marnie.`
    },
    {
    ...
    {
        genre: ["aventure", "action", "épique", "science-fiction"],
    ...
    {
        genre: ["action", "fantasy", "drame", "épique"],
    ...
    {
        genre: ["aventure", "action", "épique", "fantasy"],
    ...
    {
        genre: ["action", "épique", "fantasy", "aventure"],
    ...
    {
        genre: ["aventure", "action", "fantasy", "science-fiction"],
    ...
    {
        genre: ["anime", "action", "romance", "drame"],
        title: "Le château ambulant",
        image: "images/le_chateau_ambulant.jpg",
        text: `Sophie, une orpheline de 18 ans, travaille dur dans la boutique de chapelier que lui a laissée son père. Un jour, en ville, elle croise Hauru, un magicien très séduisant mais faible de caractère. Une sorcière, se méprenant sur leurs sentiments, change Sophie en une vieille femme de 90 ans. Désespérée, Sophie erre dans la campagne quand elle aperçoit un étrange château qui se déplace sur d'immenses pattes.`
    }

];

var genre = {
    "all genre": filmData.length,
    "aventure": 0,
    "action": 0,
    "anime": 0,
    "drame": 0,
